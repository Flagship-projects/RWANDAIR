  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] items-end overflow-hidden bg-ink">
      ...
      <div className="relative z-10 mx-auto w-full max-w-shell px-gutter pb-20 pt-40 sm:pb-28">
        <p className="hero-fade mb-6 text-fluid-xs uppercase tracking-wideish text-ochre-300 opacity-0">
          Rwanda&rsquo;s national carrier
        </p>
        <h1
          ref={titleRef}
          className="max-w-4xl font-display text-fluid-display font-light leading-[0.95] tracking-tightest text-paper"
        >
      ...
      <div className="hero-fade absolute bottom-8 right-gutter z-10 hidden flex-col items-end gap-2 text-right text-fluid-xs uppercase tracking-wideish text-paper/55 opacity-0 sm:flex">
